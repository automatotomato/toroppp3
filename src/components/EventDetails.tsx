    ...
    <section className="py-24 bg-brand-main">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <div className="bg-slate-800 p-8 rounded-xl shadow-xl text-center border border-slate-700 hover:border-brand-accent transition-colors">
            <Calendar className="text-brand-accent mx-auto mb-4" size={48} />
          ...
          <div className="bg-slate-800 p-8 rounded-xl shadow-xl text-center border border-slate-700 hover:border-brand-accent transition-colors">
            <Clock className="text-brand-accent mx-auto mb-4" size={48} />
