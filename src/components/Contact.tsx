    ...
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-brand-main rounded-2xl shadow-2xl p-8 md:p-12 text-center">
            <div className="mb-8">
            ...
            <div className="space-y-4 mb-8">
              <a
                href="tel:9154901889"
                className="flex items-center justify-center gap-3 text-slate-300 hover:text-brand-accent transition-colors text-lg"
              >
                <Phone size={24} />
            ...
            <div className="flex justify-center gap-6 pt-6 border-t border-slate-700">
              <a
                href="#"
                className="w-12 h-12 bg-slate-800 hover:bg-brand-accent rounded-full flex items-center justify-center transition-all duration-300 transform hover:scale-110"
                aria-label="LinkedIn"
              >
